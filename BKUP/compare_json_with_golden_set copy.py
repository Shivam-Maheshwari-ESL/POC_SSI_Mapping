...
def parse_args() -> argparse.Namespace:
	...
	parser.add_argument(
		...
		help="Path to expected Excel file.",
	)
	parser.add_argument(
		"--sheet",
		default="4.",
		help="Excel sheet name containing expected values.",
	)
	parser.add_argument(
		"--header-row",
		type=int,
	...
	parser.add_argument(
		"--json",
		# default="./output_llm_on_ADI/output_output_4_prebuilt-layout_gpt-5.4_intermediate.json",
		default="./output_llm_on_ADI/output_output_4_prebuilt-layout_gpt-5.4.json",
		help="Path to JSON file containing records[*].fields[*].fieldName/mappedValue.",
	)
	parser.add_argument(
		"--out-csv",
		# default="./comparision/comparison_sheet4_vs_output4_intermediate.csv",
		default="./comparision/comparison_sheet4_vs_output4.csv",
